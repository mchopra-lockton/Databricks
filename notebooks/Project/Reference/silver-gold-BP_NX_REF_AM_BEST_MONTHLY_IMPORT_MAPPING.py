...
# MAGIC   GoldDimTableName = "BP_NX_REF_AM_BEST_MONTHLY_IMPORT_MAPPING"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Carrier/MDS2/AMBestMonthlyImport/" + yymmManual + "/AMBestMonthlyImport_" + yyyymmddManual + ".parquet"
