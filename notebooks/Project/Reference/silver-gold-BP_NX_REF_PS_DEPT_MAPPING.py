...
# MAGIC   GoldDimTableName = "BP_NX_REF_PS_DEPT_MAPPING"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Person/PSHR/PS_Z_DEPT_TBL/" + yymmManual + "/PS_Z_DEPT_TBL_" + yyyymmddManual + ".parquet"
