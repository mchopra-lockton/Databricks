...
# MAGIC   GoldDimTableName = "BP_NX_REF_PS_PRD_REVENUE_MAPPING"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Reference/PSFIN/PS_Z_PRD_REVENUE/" + yymmManual + "/PS_Z_PRD_REVENUE_" + yyyymmddManual + ".parquet"
