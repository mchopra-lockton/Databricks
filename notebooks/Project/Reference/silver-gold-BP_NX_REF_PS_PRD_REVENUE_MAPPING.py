...
sourceSilverFolderPath = "Reference/PSFIN/PS_Z_PRD_REVENUE/" +now.strftime("%Y") + "/" + now.strftime("%m")
sourceSilverPath = SilverContainerPath + sourceSilverFolderPath

sourceSilverFile = "PS_Z_PRD_REVENUE_" + now.strftime("%Y") + "_" + now.strftime("%m") + "_" + now.strftime("%d") + ".parquet"
...
if (GoldDimTableName == "" or sourceSilverPath == "" or sourceSilverFile == ""):
  now = datetime.now() 
  GoldDimTableName = "BP_NX_REF_PS_PRD_REVENUE_MAPPING"
  sourceSilverPath = "Reference/PSFIN/PS_Z_PRD_REVENUE/" +now.strftime("%Y") + "/05"
  sourceSilverPath = SilverContainerPath + sourceSilverPath
  sourceSilverFile = "PS_Z_PRD_REVENUE_2021_06_15.parquet"
  sourceSilverFilePath = sourceSilverPath + "/" + sourceSilverFile
  badRecordsPath = badRecordsRootPath + GoldDimTableName + "/"
  recordCountFilePath = badRecordsPath + date_time + "/" + "RecordCount"
  BatchId = "1afc2b6c-d987-48cc-ae8c-a7f41ea27249"
  WorkFlowId ="8fc2895d-de32-4bf4-a531-82f0c6774221"
sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Reference/PSFIN/PS_Z_PRD_REVENUE/2021/06/PS_Z_PRD_REVENUE_2021_06_15.parquet"
...
# MAGIC   lazy val GoldDimTableName = "BP_NX_REF_PS_PRD_REVENUE_MAPPING"
# MAGIC }  
...
sourceSilverDF.createOrReplaceTempView("BP_NX_REF_PS_PRD_REVENUE_MAPPING")
...
Z_PRODUCER AS PRODCR_CD,
DESCR AS PRODCR,
Z_PERCENT AS PRODCR_PERCENTAGE,
DEPTID AS MASTERPRODUCERCODE,
ACCOUNT AS STAT_ACCOUNT,
'{ BatchId }' AS ETL_BATCH_ID,
'{ WorkFlowId }' AS ETL_WRKFLW_ID,
current_timestamp() AS ETL_CREATED_DT,
current_timestamp() AS ETL_UPDATED_DT
from BP_NX_REF_PS_PRD_REVENUE_MAPPING
"""
)
display(finalDataDF)
