...
# MAGIC   GoldDimTableName = "Dim_NX_Comm_Tax"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  BatchId = "1afc2b6c-d987-48cc-ae8c-a7f41ea27249"
  WorkFlowId ="8fc2895d-de32-4bf4-a531-82f0c6774221"
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Invoice/Nexsure/DimCommissionableTaxable/" + yymmManual + "/DimCommissionableTaxable_" + yyyymmddManual + ".parquet"
