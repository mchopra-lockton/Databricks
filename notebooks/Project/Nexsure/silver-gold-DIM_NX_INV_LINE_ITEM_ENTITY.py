...
# MAGIC   GoldDimTableName = "DIM_NX_INV_LINE_ITEM_ENTITY"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Invoice/Nexsure/DimInvoiceLineItemEntity/" + yymmManual + "/DimInvoiceLineItemEntity_" + yyyymmddManual + ".parquet"
