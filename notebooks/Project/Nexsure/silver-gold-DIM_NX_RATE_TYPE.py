...
# MAGIC   GoldDimTableName = "DIM_NX_RATE_TYPE"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Invoice/Nexsure/DimRateType/" + yymmManual + "/DimRateType_" + yyyymmddManual + ".parquet"
