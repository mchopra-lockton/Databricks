...
# MAGIC   GoldDimTableName = "Dim_NX_LOB"
# MAGIC }
...
if (RunInDebugMode != 'No'):
  ...
  sourceSilverFilePath = "abfss://c360silver@dlsldpdev01v8nkg988.dfs.core.windows.net/Invoice/Nexsure/DimLineItemLoB/" + yymmManual + "/DimLineItemLoB_" + yyyymmddManual + ".parquet"
